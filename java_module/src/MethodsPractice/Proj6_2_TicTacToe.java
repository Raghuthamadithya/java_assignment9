...
public class Proj6_2_TicTacToe {
    ...
    public static void getUserInput(boolean xTurn,String[][] gameBoard)
    {
        ...
        while(keepAsking)
        {
            System.out.println("please enter the row THEN"+"the column each from 0,1,0r 2,"+"separated by a space");
    ...
    public static String getWinner(String[][] gameBoard)
    {
        ...
        {
            if(!gameBoard[i][0].equals(" ")&& gameBoard[i][0].equals(gameBoard[i][1])&&gameBoard[i][0].equals(gameBoard[i][1]))
            {
